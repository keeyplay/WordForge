...
if(localStorage.getItem('Profile') && !JSON.parse(localStorage.getItem(localStorage.getItem('Profile'))).languageCards) {
    ...
    if(localStorage.getItem("language") === "ar") showNotification("مرحبًا بك في WordForge 🃏", "تعلم باستخدام البطاقات التعليمية. اقلب، احفظ، كرر. الإحصائيات والسلاسل والعملات بالداخل. أضف بطاقتك الأولى للبدء.");
}
