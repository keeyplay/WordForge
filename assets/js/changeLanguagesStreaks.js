function UpdateStreakMessageTranslate() {
    if(localStorage.getItem("language") === "en") {
        ...
        if(streakMessages) {
            streakMessages = [
                "新连续记录已解锁！🚀 坚持比强度更重要。每一天都很重要。",
                "连续记录继续！🔥 不快但稳定。这就是获胜的方式。",
                "又一天，又一步。🐢 你的连续记录在增长。继续加油。",
                "你又出现了。💪 这就是全部秘密。连续记录还活着。",
                "没有零日。✅ 连续记录已保存。明天是下一场战斗。",
                "一块一块。🧱 你的连续记录正在变成一堵墙。不要停下。",
                "离目标又近了一天。🎯 连续记录完好。尊重。",
                "并非每一天都是飞跃。但每一天都很重要。🦾 连续记录已更新。",
                "你今天没有放弃。🔥 这就是胜利。连续记录还活着。",
                "一小步，大连续记录。🐢 坚持 > 天赋。每次都是。",
                "连续记录延长了。📈 不完美，但存在就足够了。",
                "又一天记录在册。📚 连续记录 = 你可以信任自己的证明。",
                "连续记录是一面镜子。🪞 它展示了你真正的样子。今天：坚强。",
                "你本可以跳过。你没有。👊 连续记录值得尊重。",
                "又一天。又一次提交。又一步走向你想要的生活。🚀 连续记录已确保。"
            ];
        } else {
            let streakMessages = [
                "新连续记录已解锁！🚀 坚持比强度更重要。每一天都很重要。",
        ...
        if(streakMessages) {
            streakMessages = [
                "नई लगातार शुरू! 🚀 तीव्रता से अधिक निरंतरता। हर दिन मायने रखता है।",
                "लगातार जारी है! 🔥 तेज़ नहीं, लेकिन स्थिर। इसी तरह जीतते हैं।",
                "एक और दिन, एक और कदम। 🐢 आपकी लगातार बढ़ रही है। चलते रहें।",
                "आप फिर आए। 💪 यही पूरा रहस्य है। लगातार जीवित है।",
                "कोई शून्य दिन नहीं। ✅ लगातार सुरक्षित। कल अगली लड़ाई है।",
                "ईंट दर ईंट। 🧱 आपकी लगातार दीवार बन रही है। रुकें नहीं।",
                "लक्ष्य से एक दिन करीब। 🎯 लगातार बरकरार। सम्मान।",
                "हर दिन छलांग नहीं है। लेकिन हर दिन मायने रखता है। 🦾 लगातार अपडेट।",
                "आज आपने हार नहीं मानी। 🔥 यही जीत है। लगातार जीवित है।",
                "छोटा कदम, बड़ी लगातार। 🐢 निरंतरता > प्रतिभा। हर बार।",
                "लगातार बढ़ी। 📈 सही नहीं, लेकिन मौजूद। यही काफी है।",
                "एक और दिन किताबों में। 📚 लगातार = सबूत कि आप खुद पर भरोसा कर सकते हैं।",
                "लगातार एक दर्पण है। 🪞 यह दिखाता है कि आप वास्तव में कौन हैं। आज: मजबूत।",
                "आप छोड़ सकते थे। नहीं छोड़ा। 👊 लगातार सम्मानित।",
                "एक और दिन। एक और कमिट। एक और कदम उस जीवन की ओर जो आप चाहते हैं। 🚀 लगातार सुरक्षित।"
            ];
        } else {
            let streakMessages = [
                "नई लगातार शुरू! 🚀 तीव्रता से अधिक निरंतरता। हर दिन मायने रखता है।",
        ...
        if(streakMessages) {
            streakMessages = [
                "تم فتح سلسلة جديدة! 🚀 الاستمرارية أهم من الشدة. كل يوم مهم.",
                "السلسلة مستمرة! 🔥 ليس سريعًا، لكن ثابتًا. هكذا تفوز.",
                "يوم آخر، خطوة أخرى. 🐢 سلسلتك تنمو. استمر.",
                "لقد ظهرت مرة أخرى. 💪 هذا هو السر كله. السلسلة حية.",
                "لا أيام صفرية. ✅ السلسلة محفوظة. الغد هو المعركة القادمة.",
                "طوبة فوق طوبة. 🧱 سلسلتك تصبح جدارًا. لا تتوقف.",
                "يوم أقرب للهدف. 🎯 السلسلة سليمة. احترام.",
                "ليس كل يوم قفزة. لكن كل يوم مهم. 🦾 السلسلة محدّثة.",
                "لم تستسلم اليوم. 🔥 هذا هو الفوز. السلسلة تعيش.",
                "خطوة صغيرة، سلسلة كبيرة. 🐢 الاستمرارية > الموهبة. كل مرة.",
                "تم تمديد السلسلة. 📈 ليست مثالية، لكنك حاضر. هذا يكفي.",
                "يوم آخر في السجلات. 📚 السلسلة = دليل أنك تثق بنفسك.",
                "السلسلة مرآة. 🪞 تُظهر من أنت حقًا. اليوم: قوي.",
                "كان بإمكانك التخطي. لم تفعل. 👊 السلسلة مُكرَّمة.",
                "يوم آخر. التزام آخر. خطوة أخرى نحو الحياة التي تريدها. 🚀 السلسلة مأمونة."
            ];
        } else {
            let streakMessages = [
                "تم فتح سلسلة جديدة! 🚀 الاستمرارية أهم من الشدة. كل يوم مهم.",
