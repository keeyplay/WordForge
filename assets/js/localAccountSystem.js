...
function openModalLocalAccounts() {
        ...
        for(let accountsCount = 0; accountsCount < localStorage.length; accountsCount++) {
            if(localStorage.key(accountsCount) !== "language" && localStorage.key(accountsCount) !== "Profile" && localStorage.key(accountsCount) !== "ThemeMode" && localStorage.key(accountsCount) !== "languageCards" && localStorage.key(accountsCount) !== "font" && localStorage.key(accountsCount) !== "coins") { //will refactor
...
function HowManyProfiles() {
    let count = 0;
    for(let accountsCount = 0; accountsCount < localStorage.length; accountsCount++) {
        if(localStorage.key(accountsCount) !== "language" && localStorage.key(accountsCount) !== "Profile" && localStorage.key(accountsCount) !== "ThemeMode" && localStorage.key(accountsCount) !== "languageCards" && localStorage.key(accountsCount) !== "font" && localStorage.key(accountsCount) !== "coins") {
            count++
